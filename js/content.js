(function (source) {
    ...
    realHistoryDiv.id = "history";
    var realHistoryContent = '<div id="realHistory" style="width: 200px; z-index: 500; position: fixed; top: 200px; left: 28px; display: block; padding: 0 35px; height: 36px; font-size: 16px; font-weight: normal; color: #FFF; cursor: pointer; line-height: 36px; text-align: center; background-color: #ff9e40; border-left: 2px solid #FFF; border-right: 2px solid #FFF;">真の我的快递单</div><div id="historyPanel" style="overflow: scroll; display: block; z-index: 500; width: 268px; height: 200px; position: fixed; top: 240px; border: 1px dashed blue; left: 30px;"></div>';
    ...
    document.addEventListener("DOMNodeInserted", function(event){
        ...
        if(node.getAttribute('id')){
            ...
            }else if(/history/.test(node.getAttribute('id'))){
                var panelContent = "";
